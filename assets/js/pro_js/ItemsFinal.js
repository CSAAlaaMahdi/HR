                        ...
                        if (e.value != null) {
                            $.ajax({
                                ...
                                success: function (response) {
                                    ...
                                    let parentid = Number(
                                        response.getItemTwo.IT_ParentID
                                    );
                                    if (response) {
                                        $("#IT_ID")
                                            .dxTextBox("instance")
                                            .option(
                                                "value",
                                                response.getItemTwo.id
                                            );
                                        $("#IT_Name")
                                            .dxTextBox("instance")
                                            .option(
                                                "value",
                                                response.getItemTwo.IT_Name
                                            );
                                        $("#IT_ParentID")
                                        ...
                                        $("#IT_Kind")
                                            ...
                                            .option(
                                                "value",
                                                response.getItemTwo.IT_Kind
                                            );
                                        $("#IT_Ask_Stop")
                                            .dxNumberBox("instance")
                                            .option(
                                                "value",
                                                response.getItemTwo.IT_Ask_Stop
                                            );
                                        $("#IT_Description")
                                            .dxTextArea("instance")
                                            .option(
                                        ...
                                        $("#IT_Notes")
                                            ...
                                            .option(
                                                "value",
                                                response.getItemTwo.IT_Notes
                                            );
                                        $("#IT_Dim")
                                            .dxTextBox("instance")
                                            .option(
                                                "value",
                                                response.getItemTwo.IT_Dim
                                            );
                                        $("#IT_Color")
                                            .dxTextBox("instance")
                                            .option(
                                                "value",
                                                response.getItemTwo.IT_Color
                                            );
                                        $("#IT_CountIn")
                                            .dxNumberBox("instance")
                                            .option(
                                                "value",
                                                response.getItemTwo.IT_CountIn
                                            );
                                        $("#IT_ItemCount")
                                            .dxTextBox("instance")
                                            .option(
                                                "value",
                                                response.getItemTwo.IT_ItemCount
                                            );
                                        $("#IT_Higx")
                                            .dxNumberBox("instance")
                                            .option(
                                                "value",
                                                response.getItemTwo.IT_Higx
                                            );
                                        $("#IT_Lowx")
                                            .dxNumberBox("instance")
                                            .option(
                                                "value",
                                                response.getItemTwo.IT_Lowx
                                            );
                                        $("#IT_State")
                                            .dxSwitch("instance")
                                            .option(
                                                "value",
                                                response.getItemTwo.IT_State
                                            );
                                        $("#IT_Factory2")
                                            .dxNumberBox("instance")
                                            .option(
                                                "value",
                                                response.getItemTwo.IT_Factory2
                                            );
                                        $("#IT_Factory3")
                                            .dxNumberBox("instance")
                                            .option(
                                                "value",
                                                response.getItemTwo.IT_Factory3
                                            );

                                        if (
                                            response.getItemTwo
                                                .IT_ItemUnitDefualt == 1
                                        ) {
                                            reloadRadioGroup();
                                            $("#IT_GroupButtons")
                                                .dxRadioGroup("instance")
                                                .option("value[0].value", true);
                                        } else if (
                                            response.getItemTwo
                                                .IT_ItemUnit2Defualt == 1
                                        ) {
                                            reloadRadioGroup();
                                            $("#IT_GroupButtons")
                                                .dxRadioGroup("instance")
                                            ...
                                            response.getItemTwo
                                                .IT_ItemUnit3Defualt == 1
                                        ) {
                                            reloadRadioGroup();
                                            $("#IT_GroupButtons")
                                                .dxRadioGroup("instance")
                                                .option("value[2].value", true);
                                        } else {
                                            reloadRadioGroup();
                                            $("#IT_GroupButtons")
                                                .dxRadioGroup("instance")
                                        ...
                                        $("#IT_Normal_1_1")
                                            ...
                                            .option(
                                                ...
                                                parseFloat(
                                                    response.getItemTwo
                                                        .IT_Normal_1_1
                                                ) > 0 ? parseFloat(response.getItemTwo.IT_Normal_1_1) : 0
                                            );
                                        $("#IT_Mid_1_1")
                                            .dxNumberBox("instance")
                                            .option(
                                                ...
                                                parseFloat(
                                                    response.getItemTwo
                                                        .IT_Mid_1_1
                                                )> 0 ? parseFloat(response.getItemTwo.IT_Mid_1_1) : 0
                                            );
                                        $("#IT_Good_1_1")
                                            .dxNumberBox("instance")
                                            .option(
                                                ...
                                                parseFloat(
                                                    response.getItemTwo
                                                        .IT_Good_1_1
                                                )> 0 ? parseFloat(response.getItemTwo.IT_Good_1_1) : 0
                                            );
                                        $("#IT_VeryGood_1_1")
                                            .dxNumberBox("instance")
                                            .option(
                                                ...
                                                parseFloat(
                                                    response.getItemTwo
                                                        .IT_VeryGood_1_1
                                                )> 0 ? parseFloat(response.getItemTwo.IT_VeryGood_1_1) : 0
                                            );
                                        $("#IT_Excellent_1_1")
                                            .dxNumberBox("instance")
                                            .option(
                                                ...
                                                parseFloat(
                                                    response.getItemTwo
                                                        .IT_Excellent_1_1
                                                )> 0 ? parseFloat(response.getItemTwo.IT_Excellent_1_1) : 0
                                            );
                                        $("#IT_Supper_1_1")
                                            .dxNumberBox("instance")
                                            .option(
                                                ...
                                                parseFloat(
                                                    response.getItemTwo
                                                        .IT_Supper_1_1
                                                )> 0 ? parseFloat(response.getItemTwo.IT_Supper_1_1) : 0
                                            );
                                        $("#IT_Normal_2_1")
                                            .dxNumberBox("instance")
                                            .option(
                                                ...
                                                parseFloat(
                                                    response.getItemTwo
                                                        .IT_Normal_2_1
                                                )> 0 ? parseFloat(response.getItemTwo.IT_Normal_2_1) : 0
                                            );
                                        $("#IT_Mid_2_1")
                                            .dxNumberBox("instance")
                                            .option(
                                                ...
                                                parseFloat(
                                                    response.getItemTwo
                                                        .IT_Mid_2_1
                                                )> 0 ? parseFloat(response.getItemTwo.IT_Mid_2_1) : 0
                                            );
                                        $("#IT_Good_2_1")
                                            .dxNumberBox("instance")
                                            .option(
                                                ...
                                                parseFloat(
                                                    response.getItemTwo
                                                        .IT_Good_2_1
                                                )> 0 ? parseFloat(response.getItemTwo.IT_Good_2_1) : 0
                                            );
                                        $("#IT_VeryGood_2_1")
                                            .dxNumberBox("instance")
                                            .option(
                                                ...
                                                parseFloat(
                                                    response.getItemTwo
                                                        .IT_VeryGood_2_1
                                                )> 0 ? parseFloat(response.getItemTwo.IT_VeryGood_2_1) : 0
                                            );
                                        $("#IT_Excellent_2_1")
                                            .dxNumberBox("instance")
                                            .option(
                                                ...
                                                parseFloat(
                                                    response.getItemTwo
                                                        .IT_Excellent_2_1
                                                )> 0 ? parseFloat(response.getItemTwo.IT_Excellent_2_1) : 0
                                            );
                                        $("#IT_Supper_2_1")
                                            .dxNumberBox("instance")
                                            .option(
                                                ...
                                                parseFloat(
                                                    response.getItemTwo
                                                        .IT_Supper_2_1
                                                )> 0 ? parseFloat(response.getItemTwo.IT_Supper_2_1) : 0
                                            );
                                        $("#IT_Normal_3_1")
                                            .dxNumberBox("instance")
                                            .option(
                                                ...
                                                parseFloat(
                                                    response.getItemTwo
                                                        .IT_Normal_3_1
                                                )> 0 ? parseFloat(response.getItemTwo.IT_Normal_3_1) : 0
                                            );
                                        $("#IT_Mid_3_1")
                                            .dxNumberBox("instance")
                                            .option(
                                                ...
                                                parseFloat(
                                                    response.getItemTwo
                                                        .IT_Mid_3_1
                                                )> 0 ? parseFloat(response.getItemTwo.IT_Mid_3_1) : 0
                                            );
                                        $("#IT_Good_3_1")
                                            .dxNumberBox("instance")
                                            .option(
                                                ...
                                                parseFloat(
                                                    response.getItemTwo
                                                        .IT_Good_3_1
                                                )> 0 ? parseFloat(response.getItemTwo.IT_Good_3_1) : 0
                                            );
                                        $("#IT_VeryGood_3_1")
                                            .dxNumberBox("instance")
                                            .option(
                                                ...
                                                parseFloat(
                                                    response.getItemTwo
                                                        .IT_VeryGood_3_1
                                                )> 0 ? parseFloat(response.getItemTwo.IT_VeryGood_3_1) : 0
                                            );
                                        $("#IT_Excellent_3_1")
                                            .dxNumberBox("instance")
                                            .option(
                                                ...
                                                parseFloat(
                                                    response.getItemTwo
                                                        .IT_Excellent_3_1
                                                )> 0 ? parseFloat(response.getItemTwo.IT_Excellent_3_1) : 0
                                            );
                                        $("#IT_Supper_3_1")
                                            .dxNumberBox("instance")
                                            .option(
                                                ...
                                                parseFloat(
                                                    response.getItemTwo
                                                        .IT_Supper_3_1
                                                )> 0 ? parseFloat(response.getItemTwo.IT_Supper_3_1) : 0
                                            );
                                        ...
                                        $("#IT_Company")
                                            ...
                                            .option(
                                                "value",
                                                response.getItemTwo.IT_Company
                                            );
                                        $("#IT_Brand")
                                            .dxDropDownBox("instance")
                                            .option(
                                                "value",
                                                response.getItemTwo.IT_Brand
                                            );
                                        $("#IT_ItemUnit")
                                            .dxDropDownBox("instance")
                                            .option(
                                                "value",
                                                response.getItemTwo.IT_ItemUnit
                                            );
                                        $("#IT_ItemUnit2")
                                            .dxDropDownBox("instance")
                                            .option(
                                                "value",
                                                response.getItemTwo.IT_ItemUnit2
                                            );
                                        $("#IT_ItemUnit3")
                                            .dxDropDownBox("instance")
                                            .option(
                                                "value",
                                                response.getItemTwo.IT_ItemUnit3
                                            );
...
function clear_Data() {
    ...
    $("#IT_CountIn").dxNumberBox("instance").option("value", 0);
    $("#IT_ItemCount").dxTextBox("instance").option("value", 0);
    $("#IT_Higx").dxNumberBox("instance").option("value", 0);
    $("#IT_Lowx").dxNumberBox("instance").option("value", 0);
    $("#IT_Kind").dxTextBox("instance").option("value", "");
    $("#IT_Ask_Stop").dxNumberBox("instance").option("value", 0);
    ...
    $("#IT_Factory2").dxNumberBox("instance").option("value", null);
    $("#IT_Factory3").dxNumberBox("instance").option("value", null);
    $("#IT_GroupButtons").dxRadioGroup("instance").option("value", "Unit");
    $("#IT_Normal_1_1").dxNumberBox("instance").option("value", 0);
    $("#IT_Mid_1_1").dxNumberBox("instance").option("value", 0);
    $("#IT_Good_1_1").dxNumberBox("instance").option("value", 0);
    $("#IT_VeryGood_1_1").dxNumberBox("instance").option("value", 0);
    $("#IT_Excellent_1_1").dxNumberBox("instance").option("value", 0);
    $("#IT_Supper_1_1").dxNumberBox("instance").option("value", 0);
    $("#IT_Normal_2_1").dxNumberBox("instance").option("value", 0);
    $("#IT_Mid_2_1").dxNumberBox("instance").option("value", 0);
    $("#IT_Good_2_1").dxNumberBox("instance").option("value", 0);
    $("#IT_VeryGood_2_1").dxNumberBox("instance").option("value", 0);
    $("#IT_Excellent_2_1").dxNumberBox("instance").option("value", 0);
    $("#IT_Supper_2_1").dxNumberBox("instance").option("value", 0);
    $("#IT_Normal_3_1").dxNumberBox("instance").option("value", 0);
    $("#IT_Mid_3_1").dxNumberBox("instance").option("value", 0);
    $("#IT_Good_3_1").dxNumberBox("instance").option("value", 0);
    $("#IT_VeryGood_3_1").dxNumberBox("instance").option("value", 0);
    $("#IT_Excellent_3_1").dxNumberBox("instance").option("value", 0);
    $("#IT_Supper_3_1").dxNumberBox("instance").option("value", 0);
    $("#IT_LastPrice").dxNumberBox("instance").option("value", 0);
    $("#IT_LastPrice2").dxNumberBox("instance").option("value", 0);
    $("#IT_LastPrice3").dxNumberBox("instance").option("value", 0);
    $("#IT_Average").dxNumberBox("instance").option("value", 0);
    $("#IT_Average2").dxNumberBox("instance").option("value", 0);
    $("#IT_Average3").dxNumberBox("instance").option("value", 0);
...
function Item_InsertData() {
    let url = "items";
    let radioGroup = $("#IT_GroupButtons").dxRadioGroup("instance");
    let selectedValue = radioGroup.option("value");
    let unit1 = false,
        unit2 = false,
        unit3 = false;
    ...
    let data = {
        ...
        IT_ArabicName: $("#IT_ArabicName")
            .dxTextBox("instance")
            .option("value"),
        IT_PartNumber: $("#IT_PartNumber")
            .dxTextBox("instance")
            .option("value"),
        IT_PartNumber2: $("#IT_PartNumber2")
            .dxTextBox("instance")
            .option("value"),
        IT_CPartNumber: $("#IT_CPartNumber")
            .dxTextBox("instance")
            .option("value"),
        IT_GenuinePartNumber: $("#IT_GenuinePartNumber")
            .dxTextBox("instance")
            .option("value"),
        ...
        IT_ItemUnit: $("#IT_ItemUnit")
            .dxDropDownBox("instance")
            .option("value"),
        IT_ItemUnit2: $("#IT_ItemUnit2")
            .dxDropDownBox("instance")
            .option("value"),
        IT_ItemUnit3: $("#IT_ItemUnit3")
            .dxDropDownBox("instance")
            .option("value"),
        ...
        IT_Normal_1_1: $("#IT_Normal_1_1")
            .dxNumberBox("instance")
            .option("value"),
        IT_Mid_1_1: $("#IT_Mid_1_1").dxNumberBox("instance").option("value"),
        IT_Good_1_1: $("#IT_Good_1_1").dxNumberBox("instance").option("value"),
        IT_VeryGood_1_1: $("#IT_VeryGood_1_1")
            .dxNumberBox("instance")
            .option("value"),
        IT_Excellent_1_1: $("#IT_Excellent_1_1")
            .dxNumberBox("instance")
            .option("value"),
        IT_Supper_1_1: $("#IT_Supper_1_1")
            .dxNumberBox("instance")
            .option("value"),
        IT_Normal_2_1: $("#IT_Normal_2_1")
            .dxNumberBox("instance")
            .option("value"),
        IT_Mid_2_1: $("#IT_Mid_2_1").dxNumberBox("instance").option("value"),
        IT_Good_2_1: $("#IT_Good_2_1").dxNumberBox("instance").option("value"),
        IT_VeryGood_2_1: $("#IT_VeryGood_2_1")
            .dxNumberBox("instance")
            .option("value"),
        IT_Excellent_2_1: $("#IT_Excellent_2_1")
            .dxNumberBox("instance")
            .option("value"),
        IT_Supper_2_1: $("#IT_Supper_2_1")
            .dxNumberBox("instance")
            .option("value"),
        IT_Normal_3_1: $("#IT_Normal_3_1")
            .dxNumberBox("instance")
            .option("value"),
        IT_Mid_3_1: $("#IT_Mid_3_1").dxNumberBox("instance").option("value"),
        IT_Good_3_1: $("#IT_Good_3_1").dxNumberBox("instance").option("value"),
        IT_VeryGood_3_1: $("#IT_VeryGood_3_1")
            .dxNumberBox("instance")
            .option("value"),
        IT_Excellent_3_1: $("#IT_Excellent_3_1")
            .dxNumberBox("instance")
            .option("value"),
        IT_Supper_3_1: $("#IT_Supper_3_1")
            .dxNumberBox("instance")
            .option("value"),
    };
...
function Item_Checking() {
    ...
    if (
        $("#IT_GenuinePartNumber").dxTextBox("instance").option("value") == ""
    ) {
...
$(document).ready(function () {
    ...
    $(() => {
        ...
        var textBoxInputElement = $(
            "#IT_PartNumber2 input.dx-texteditor-input"
        );
        textBoxInputElement.on("input", function (event) {
            // Handle the 'input' event here if needed
            var newText = event.target.value;
    ...
    $(() => {
        $("#IT_Ask_Stop").dxNumberBox({
            ...
            value: 0, // Initial value, you can set this to any default value you want
    ...
    $(() => {
        $("#IT_Normal_1_1").dxNumberBox({
            ...
            value: null, // Initial value, you can set this to any default value you want
            showSpinButtons: true, // Enable spin buttons for easier value adjustment
            format: "#0.00", // Format the number without decimal places
            step: 1, // Set the step for incremental adjustments
            useLargeSpinButtons: true, // Use larger spin buttons for better touch usability
            // Add any other options you need
